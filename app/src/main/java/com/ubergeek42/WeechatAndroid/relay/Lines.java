...
public class Lines {
    ...
    private final static Line HEADER = new Line(HEADER_POINTER, null, 0, "", "", null, false, false, Line.DisplayAs.UNSPECIFIED, Line.Notify.UNSPECIFIED);
    private final static Line MARKER = new Line(MARKER_POINTER, null, 0, "", "", null, false, false, Line.DisplayAs.UNSPECIFIED, Line.Notify.UNSPECIFIED);

    ...
    public void handleMessage(RelayObject obj, String id) {
        if (id.equals("_buffer_line_added")) { // New line added...what is it?
            ...
            for (int i = 0; i < hdata.getCount(); i++) {
                ...
                // Determine if buffer is a privmessage(check localvar "type" for value "private"),
                // and notify for that too
                ...
                String notificationText = Color.stripColors(hde.getItem("prefix").asString())
                        + ": " + Color.stripColors(hde.getItem("message").asString());
